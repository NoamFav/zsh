...
export DYLD_LIBRARY_PATH="$HOME/Neoware/iris_initiative/utils/porcupine/lib/mac/arm64:$DYLD_LIBRARY_PATH"
export LD_LIBRARY_PATH="$(pwd)/iris.ai/libphonemizer_phonemize-arm64/lib:$LD_LIBRARY_PATH"
